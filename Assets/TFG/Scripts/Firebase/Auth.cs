...
namespace TFG.Authentification {
  public class Auth : MonoBehaviour {
    ...
    protected void DisplayProvidersForEmail() {
      auth.FetchProvidersForEmailAsync(_user.text).ContinueWithOnMainThread((authTask) => { //EmailMOD
    ...
    protected void SendPasswordResetEmail() {
      auth.SendPasswordResetEmailAsync(_user.text).ContinueWithOnMainThread((authTask) => { //EmailMOD
